...
static const char DEFAULT_SLOT0_JSON[] = R"json({"name":"Blooming","phases":[{"type":"PRESSURE","target":{"start":-1,"end":3.0,"curve":"INSTANT","time":0},"restriction":6.0,"stopConditions":{"time":10000}},{"type":"PRESSURE","target":{"start":3.0,"end":9.0,"curve":"LINEAR","time":6000},"restriction":9.0,"stopConditions":{"time":6000}},{"type":"PRESSURE","target":{"start":9.0,"end":6.0,"curve":"EASE_OUT","time":12000},"restriction":9.0,"stopConditions":{"weight":50.0}}],"globalStopConditions":{"weight":40.0}})json";

// Slot 1: Conventional – classic 9 bar, minimal pre-infusion, ~25–30 s
static const char DEFAULT_SLOT1_JSON[] = R"json({"name":"Conventional","phases":[{"type":"PRESSURE","target":{"start":-1,"end":2.0,"curve":"INSTANT","time":0},"restriction":4.0,"stopConditions":{"time":3000}},{"type":"PRESSURE","target":{"start":2.0,"end":9.0,"curve":"LINEAR","time":4000},"restriction":9.0,"stopConditions":{"time":25000}},{"type":"PRESSURE","target":{"start":9.0,"end":6.0,"curve":"EASE_OUT","time":5000},"restriction":9.0,"stopConditions":{"weight":45.0}}],"globalStopConditions":{"weight":38.0}})json";
