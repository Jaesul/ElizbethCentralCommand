...
static const char DEFAULT_SLOT0_JSON[] = R"json({"name":"Blooming","phases":[{"type":"PRESSURE","target":{"start":-1,"end":3.0,"curve":"INSTANT","time":4000},"restriction":12.0,"stopConditions":{"time":4000}},{"type":"FLOW","target":{"start":0,"end":0,"curve":"INSTANT","time":8000},"restriction":0,"stopConditions":{"time":8000}},{"type":"PRESSURE","target":{"start":3.0,"end":9.0,"curve":"LINEAR","time":6000},"restriction":9.0,"stopConditions":{"time":6000}},{"type":"PRESSURE","target":{"start":9.0,"end":6.0,"curve":"EASE_OUT","time":12000},"restriction":9.0,"stopConditions":{"weight":50.0}}],"globalStopConditions":{"weight":40.0}})json";
